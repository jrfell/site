...
k_needles %>% 
  ...
  ggplot(mapping = aes(x = fct_relevel(size, c("000", "00", "0", "1", "1.5", "2", "2.5", "3", "4", "5", "6", "7", "8", "9", "10", "10.5", "11")), y = fct_relevel(type_or_length, c("dpn", "9","12", "16", "24", "32", "36", "40", "47", "straight")), fill = qty)) +
